...
enum ArrowSize { ArrowNormal, ArrowSmall, ArrowTiny };

//* internal option flags to pass arguments around
enum StyleOption { Sunken = 0x1, Focus = 0x2, Hover = 0x4, Disabled = 0x8, NoFill = 0x10, HoleOutline = 0x20, HoleContrast = 0x80 };

Q_DECLARE_FLAGS(StyleOptions, StyleOption)

//* shadow area
enum ShadowArea { ShadowAreaTop, ShadowAreaBottom, ShadowAreaLeft, ShadowAreaRight };
}
