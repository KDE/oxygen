...
//         void renderWindowBackground( QPainter* p, const QRect& clipRect, const QRect &widgetRect, const QRect &windowRect, const QColor& color, int y_shift=-23, int gradientHeight = 20 );
